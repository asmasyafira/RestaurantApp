...
final TextTheme textTheme = TextTheme(
    ...
    headline3: GoogleFonts.poppins(
        fontSize: 46, fontWeight: FontWeight.w400, letterSpacing: 0.25),
    headline4: GoogleFonts.poppins(
        fontSize: 32, fontWeight: FontWeight.w500, letterSpacing: 0.15),
    headline5: GoogleFonts.poppins(
        fontSize: 22, fontWeight: FontWeight.w600, letterSpacing: 0.15),
    headline6: GoogleFonts.poppins(
        fontSize: 18, fontWeight: FontWeight.bold),
    subtitle1: GoogleFonts.poppins(
        fontSize: 12, fontWeight: FontWeight.w300, letterSpacing: 0.15),
...
final Color primaryColor = Colors.pink[800];
final Color secondaryColor = Colors.pink[600];
